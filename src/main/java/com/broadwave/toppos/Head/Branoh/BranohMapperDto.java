...
public class BranohMapperDto {
    ...
    public String getBrContractFormDt() {
        String getBrContractFormDt = brContractFormDt;
        getBrContractFormDt = getBrContractFormDt.replaceAll("-","");
        return getBrContractFormDt;
    }
