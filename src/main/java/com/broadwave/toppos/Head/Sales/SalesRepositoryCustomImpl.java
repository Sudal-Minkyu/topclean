...
public class SalesRepositoryCustomImpl extends QuerydslRepositorySupport implements SalesRepositoryCustom {
    ...
    public List<CustomTransactionStatusDto> findByCustomTransactionStatus(String filterYear) {
        ...
        sb.append("       SELECT x.yyyymm, x.br_code, x.br_name, avg_price, price_cnt \n");
        sb.append("       FROM( \n");
        sb.append("               SELECT a.cs_yyyymm yyyymm, b.br_code, b.br_name, SUM(a.unit_price) avg_price, COUNT(a.unit_price) price_cnt \n");
        sb.append("               FROM cl_sales_unit_price_month a \n");
        sb.append("               INNER JOIN bs_branch b ON a.br_code = b.br_code \n");
        sb.append("               WHERE LEFT(a.cs_yyyymm, 4) =?1 AND a.price_type = '01' \n");
        sb.append("               GROUP BY a.cs_yyyymm, b.br_code ,b.br_name \n");
        sb.append("               UNION ALL \n");
        sb.append("               SELECT a.by_yyyymm yyyymm,b.br_code, b.br_name, 0 avg_price, 0 price_cnt \n");
        sb.append("               FROM bs_yyyymm a \n");
        sb.append("               JOIN bs_branch b \n");
        sb.append("               WHERE LEFT(a.by_yyyymm, 4)=?1 \n");
        sb.append("       ) x \n");
        ...
        sb.append("), \n");
        sb.append("pPrice as( \n");
        sb.append("       SELECT x.yyyymm, x.br_code, x.br_name, pcs_price, price_cnt \n");
        sb.append("       FROM( \n");
        sb.append("               SELECT a.cs_yyyymm yyyymm, b.br_code, b.br_name, SUM(a.unit_price) pcs_price, COUNT(a.unit_price) price_cnt \n");
        sb.append("               FROM cl_sales_unit_price_month a \n");
        sb.append("               INNER JOIN bs_branch b ON a.br_code = b.br_code \n");
        sb.append("               WHERE LEFT(a.cs_yyyymm, 4) =?1 AND a.price_type = '02' \n");
        sb.append("               GROUP BY a.cs_yyyymm, b.br_code ,b.br_name \n");
        sb.append("               UNION ALL \n");
        sb.append("               SELECT a.by_yyyymm yyyymm,b.br_code, b.br_name, 0 pcs_price, 0 price_cnt \n");
        sb.append("               FROM bs_yyyymm a \n");
        sb.append("               JOIN bs_branch b \n");
        sb.append("               WHERE LEFT(a.by_yyyymm, 4)=?1 \n");
        sb.append("       ) x \n");
        ...
        sb.append("INNER JOIN ( \n");
        sb.append("          SELECT a.yyyymm, a.br_code, avg_price/if(price_cnt=0,1,price_cnt) avg_price \n");
        sb.append("          FROM aPrice a \n");
        sb.append("          WHERE RIGHT(a.yyyymm,2)='01' \n");
        sb.append("          GROUP BY a.yyyymm, a.br_code \n");
        sb.append("	     	 ) a1 on a.br_code = a1.br_code \n");
        sb.append("INNER JOIN ( \n");
        sb.append("          SELECT p.yyyymm, p.br_code, pcs_price/if(price_cnt=0,1,price_cnt) pcs_price \n");
        ...
        sb.append("INNER JOIN ( \n");
        sb.append("          SELECT a.br_code, SUM(a.avg_price)/if(SUM(a.price_cnt)=0,1,SUM(a.price_cnt)) avg_price \n");
        sb.append("          FROM aPrice a \n");
        sb.append("          GROUP BY a.br_code \n");
        sb.append("		     ) atot on a.br_code = atot.br_code \n");
        sb.append("INNER JOIN ( \n");
        sb.append("          SELECT p.br_code, SUM(p.pcs_price)/if(SUM(p.price_cnt)=0,1,SUM(p.price_cnt)) pcs_price \n");
        sb.append("          FROM pPrice p \n");
    ...
    public List<CustomTransactionDetailStatusDto> findByCustomTransactionDetailStatus(String brCode, String filterYear) {
        ...
        sb.append("WITH aPrice as( \n");
        sb.append("        SELECT x.yyyymm, x.fr_code, x.fr_name, avg_price, price_cnt \n");
        sb.append("        FROM( \n");
        sb.append("                SELECT a.cs_yyyymm yyyymm, b.fr_code, b.fr_name, SUM(a.unit_price) avg_price, COUNT(a.unit_price) price_cnt \n");
        sb.append("                FROM cl_sales_unit_price_month a \n");
        sb.append("                INNER JOIN bs_franchise b ON a.fr_code = b.fr_code \n");
        sb.append("                WHERE LEFT(a.cs_yyyymm, 4) =?1 AND a.price_type = '01' \n");
        sb.append("                AND a.br_code = ?2 \n");
        sb.append("                GROUP BY a.cs_yyyymm, b.fr_code ,b.fr_name \n");
        sb.append("                UNION ALL \n");
        sb.append("                SELECT a.by_yyyymm yyyymm, b.fr_code, b.fr_name, 0 avg_price, 0 price_cnt \n");
        sb.append("                FROM bs_yyyymm a \n");
        sb.append("                JOIN bs_franchise b \n");
        sb.append("                WHERE LEFT(a.by_yyyymm, 4)=?1 \n");
        sb.append("                And b.br_code = ?2 \n");
        ...
        sb.append("), \n");
        sb.append("pPrice as( \n");
        sb.append("        SELECT x.yyyymm, x.fr_code, x.fr_name, pcs_price, price_cnt \n");
        sb.append("        FROM( \n");
        sb.append("                SELECT a.cs_yyyymm yyyymm, b.fr_code, b.fr_name, SUM(a.unit_price) pcs_price, COUNT(a.unit_price) price_cnt \n");
        sb.append("                FROM cl_sales_unit_price_month a \n");
        sb.append("                INNER JOIN bs_franchise b ON a.fr_code = b.fr_code \n");
        sb.append("                WHERE LEFT(a.cs_yyyymm, 4) =?1 AND a.price_type = '02' \n");
        sb.append("                AND a.br_code = ?2 \n");
        sb.append("                GROUP BY a.cs_yyyymm, b.fr_code ,b.fr_name \n");
        sb.append("                UNION ALL \n");
        sb.append("                SELECT a.by_yyyymm yyyymm, b.fr_code, b.fr_name, 0 pcs_price, 0 price_cnt \n");
        sb.append("                FROM bs_yyyymm a \n");
        sb.append("                JOIN bs_franchise b \n");
        sb.append("                WHERE LEFT(a.by_yyyymm, 4)=?1 \n");
        sb.append("                And b.br_code = ?2 \n");
        ...
        sb.append("INNER JOIN ( \n");
        sb.append("        SELECT a.yyyymm, a.fr_code, avg_price/if(price_cnt=0,1,price_cnt) avg_price \n");
        sb.append("        FROM aPrice a \n");
        sb.append("        WHERE RIGHT(a.yyyymm,2)='01' \n");
        sb.append("        GROUP BY a.yyyymm, a.fr_code \n");
        sb.append("        ) a1 on a.fr_code = a1.fr_code \n");
        sb.append("INNER JOIN ( \n");
        sb.append("        SELECT p.yyyymm, p.fr_code, pcs_price/if(price_cnt=0,1,price_cnt) pcs_price \n");
        sb.append("        FROM pPrice p \n");
        sb.append("        WHERE RIGHT(p.yyyymm,2)='01' \n");
        ...
        sb.append("INNER JOIN ( \n");
        sb.append("        SELECT a.fr_code, SUM(a.avg_price)/if(SUM(a.price_cnt)=0,1,SUM(a.price_cnt)) avg_price \n");
        sb.append("        FROM aPrice a \n");
        sb.append("        GROUP BY a.fr_code \n");
        sb.append("	       ) atot on a.fr_code = atot.fr_code \n");
        sb.append("INNER JOIN ( \n");
        sb.append("        SELECT p.fr_code, SUM(p.pcs_price)/if(SUM(p.price_cnt)=0,1,SUM(p.price_cnt)) pcs_price \n");
        sb.append("        FROM pPrice p \n");
    ...
    // 객단가, pcs단가 전체 평균 데이터 NativeQuery
    @Override
    public CustomTransactionTotalDto findByCustomTransactionTotalStatus(String filterYear) {
        EntityManager em = getEntityManager();
        StringBuilder sb = new StringBuilder();
        ...
        sb.append("        GROUP BY x.yyyymm, x.br_code \n");
        sb.append(") \n");
        sb.append("SELECT a.avg_price/if(a.price_cnt=0,1,a.price_cnt) avg_price_total, \n");
        sb.append("        p.pcs_price/if(p.price_cnt=0,1,p.price_cnt) pcs_price_total \n");
        sb.append("FROM (SELECT SUM(avg_price) avg_price, SUM(price_cnt) price_cnt FROM aPrice ) a, \n");
        sb.append("     (SELECT SUM(pcs_price) pcs_price, SUM(price_cnt) price_cnt FROM pPrice ) p \n");
