    ...
    public List<ReceiptMonthlyBranchListDto> findByReceiptMonthlyBranchList(String filterYear) {
        ...
        sb.append("WITH receiptdata as ( \n");
            ...
            sb.append("FROM ( \n");
                ...
                sb.append("SELECT a.by_yyyymm,b.br_code, 0 amt,0 inamt \n");
        ...
        sb.append("CASE WHEN x1.amt-x1.inamt = x1.amt THEN '미입금' \n");
        sb.append("WHEN x1.amt-x1.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt01, \n");
        sb.append("x1.amt-x1.inamt inamt01, \n");

        sb.append("CASE WHEN x2.amt-x2.inamt = x2.amt THEN '미입금' \n");
        sb.append("WHEN x2.amt-x2.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt02, \n");
        sb.append("x2.amt-x2.inamt inamt02, \n");

        sb.append("CASE WHEN x3.amt-x3.inamt = x3.amt THEN '미입금' \n");
        sb.append("WHEN x3.amt-x3.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt03, \n");
        sb.append("x3.amt-x3.inamt inamt03, \n");

        sb.append("CASE WHEN x4.amt-x4.inamt = x4.amt THEN '미입금' \n");
        sb.append("WHEN x4.amt-x4.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt04, \n");
        sb.append("x4.amt-x4.inamt inamt04, \n");

        sb.append("CASE WHEN x5.amt-x5.inamt = x5.amt THEN '미입금' \n");
        sb.append("WHEN x5.amt-x5.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt05, \n");
        sb.append("x5.amt-x5.inamt inamt05, \n");

        sb.append("CASE WHEN x6.amt-x6.inamt = x6.amt THEN '미입금' \n");
        sb.append("WHEN x6.amt-x6.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt06, \n");
        sb.append("x6.amt-x6.inamt inamt06, \n");

        sb.append("CASE WHEN x7.amt-x7.inamt = x7.amt THEN '미입금' \n");
        sb.append("WHEN x7.amt-x7.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt07, \n");
        sb.append("x7.amt-x7.inamt inamt07, \n");

        sb.append("CASE WHEN x8.amt-x8.inamt = x8.amt THEN '미입금' \n");
        sb.append("WHEN x8.amt-x8.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt08, \n");
        sb.append("x8.amt-x8.inamt inamt08, \n");

        sb.append("CASE WHEN x9.amt-x9.inamt = x9.amt THEN '미입금' \n");
        sb.append("WHEN x9.amt-x9.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt09, \n");
        sb.append("x9.amt-x9.inamt inamt09, \n");

        sb.append("CASE WHEN x10.amt-x10.inamt = x10.amt THEN '미입금' \n");
        sb.append("WHEN x10.amt-x10.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt10, \n");
        sb.append("x10.amt-x10.inamt inamt10, \n");

        sb.append("CASE WHEN x11.amt-x11.inamt = x11.amt THEN '미입금' \n");
        sb.append("WHEN x11.amt-x11.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt11, \n");
        sb.append("x11.amt-x11.inamt inamt11, \n");

        sb.append("CASE WHEN x12.amt-x12.inamt = x12.amt THEN '미입금' \n");
        sb.append("WHEN x12.amt-x12.inamt <= 0 THEN '입금 완료' ELSE '일부 입금' END amt12, \n");
