...
public class HeadRestController {
    ...
    public HeadRestController(AccountService accountService, NoticeService noticeService, ModelMapper modelMapper,
                              ...
                              HmTemplateService hmTemplateService, CurrentService currentService, SummaryService summaryService, PromotionService promotionService, PasswordEncoder passwordEncoder) {
