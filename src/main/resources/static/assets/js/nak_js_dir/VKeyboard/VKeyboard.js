    ...
    * */
    ...
    htmlSet(){
        ...
        <div id="VKEY_VKEYMAIN">
            <div id="VKEY_field_subject">
            </div>
            <div id="VKEY_field_editable" class="VKEY_floatleft" contenteditable="true" spellcheck="false" style="font-size: 56px"></div>
            <div>
                <input type="button" id="VKEY_btn_caretleft" class="vKeyBtn arrows" value="←">
                <input type="button" id="VKEY_btn_caretright" class="vKeyBtn arrows" value="→">
                <input type="button" id="VKEY_btn_delete" class="VKEY_floatleft" value="삭제">
                <input type="button" id="VKEY_btn_clear" class="VKEY_floatleft" value="전체삭제">
            </div>
            <div id="VKEY_main_keyboard">
                <div id="VKEY_switch_keyboard">
                    <input type="button" class="VKEY_btn_change_keyboard" value="한">
                    <input type="button" class="VKEY_btn_change_keyboard" value="A">
                    <input type="button" class="VKEY_btn_change_keyboard" value="a">
                    <input type="button" class="VKEY_btn_change_keyboard" value="특">
                    <input type="button" class="VKEY_btn_change_keyboard" value="특2">
                </div>
                <div id="VKEY_zone_boiler">
                    <input type="button" class="VKEY_btn_change_boilerpad" value="1">
                    <input type="button" class="VKEY_btn_change_boilerpad" value="2">
                    <input type="button" class="VKEY_btn_change_boilerpad" value="3">
                    <input type="button" class="VKEY_btn_change_boilerpad" value="4">
                    <div id="VKEY_bundle_boiler">
                        <div class="VKEY_pad_boiler">
                            <div class="VKEY_halfpad_boiler">
                ...
                <div id="VKEY_position_middle">
                    <div id="VKEY_bundle_ground">
                        <div id="kor" class="VKEY_bundle_keyboard">
                        
                            <div id="VKEY_pad_korleft">
